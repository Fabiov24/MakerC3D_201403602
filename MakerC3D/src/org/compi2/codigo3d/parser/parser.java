...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Fri Mar 17 23:42:21 CST 2017
  */
    ...
    throws java.lang.Exception
    {
      ...
      switch (CUP$parser$act_num)
		...
		NodoC3D der = (NodoC3D)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
                        ...
                        String LActual = ControlC3D.getL2() ;
                        String temp = ControlC3D.generaEstado();
                        String temp2 = ControlC3D.generaEstado();
                        

                        String c3d = "";
                        if(izq.getCad().charAt(0) !='L'){
                            String temp3 = ControlC3D.generaEstado();    
                            String temp4 = ControlC3D.generaEstado();
                            c3d = " if " + izq.getCad() + " go to "+ temp+";\n\t go to " + temp2+";\n"; 
                            c3d += temp2 +": if " + der.getCad() + " go to "+ temp3+";\n\t go to " + temp4+";\n";
                            c3d+=temp+ "," + temp3 +":{TRUE};\n";   
                        }else{

                            c3d += LActual +": if " + der.getCad() + " go to "+ temp+";\n\tgo to " + temp2+";\n";
                            c3d+= temp +":{TRUE};\n";   
                        }
		...
		NodoC3D der = (NodoC3D)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
                        ...
                        String LActual = ControlC3D.getL() ;
                        String temp = ControlC3D.generaEstado();
                        String temp2 = ControlC3D.generaEstado();
                        ...
                        if(izq.getCad().charAt(0) !='L'){
                            ...
                            String temp4 = ControlC3D.generaEstado();
                            c3d = " if " + izq.getCad() + " go to "+ temp+";\n\t go to " + temp2+";\n"; 
                            c3d += temp +": if " + der.getCad() + " go to "+ temp3+";\n\t go to " + temp4+";\n";
                            c3d+=temp2+ "," + temp4 +":{FALSE};\n";   
                        }else{
		...
		NodoC3D der = (NodoC3D)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 12: // expresion ::= expresion MAYOR_IGUAL expresion 
            {
              NodoC3D RESULT =null;
		int izqleft = ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-2)).left;
		int izqright = ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-2)).right;
